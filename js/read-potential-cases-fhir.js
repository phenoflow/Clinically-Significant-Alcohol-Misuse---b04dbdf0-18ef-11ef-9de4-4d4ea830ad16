...
(async () => {
  ...
  await fs.writeFile("clinically-significant-alcohol-misuse-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("clinically-significant-alcohol-misuse-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
